            ...
            <div className='bg-white w-300 flex flex-col justify-center'>
                <div>
                    <form className='max-w-[400px] w-full mx-auto bg-white p-4'>
                        ...
                        <h2 className='text-center text-xl p-3'> Create an Account! </h2>
                        ...
                        <div className='flex flex-col py-2' >
                            <label>Email</label>
                            <input className='border p-2 bg-slate-100 ' type="password" placeholder="joesmith@gmail.com" />
                        </div>
                        <div className='flex flex-col py-2' >
                            <label>Password</label>
                            <input className='border p-2 bg-slate-100 ' type="password" placeholder="**********" />
                        </div>
                        <button className='border w-full my-5 py-2 bg-[#0B7D5D] hover:bg-[#045840] text-white'>Create Account</button>
